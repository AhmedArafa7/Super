...
- **Deploy Command**: إذا ظهر لك خطأ "Required" باللون الأحمر أو منعك من الحفظ، اكتب كلمة `true` في الخانة.
- **لماذا؟**: النشر في Pages يتم تلقائياً بعد البناء. استخدام أوامر Wrangler هنا مخصص للـ Workers فقط ويسبب تعارضاً.

### 3. أول مستخدم هو المدير 👑
- أول حساب يتم إنشاؤه في النظام سيحصل تلقائياً على رتبة **المؤسس (Founder)** مع كامل الصلاحيات الإدارية والمالية.
