...
- Color palette: Background - Slate-900 (#0F172A) for a dark, futuristic base.
- Cards: Zinc-800 (#27272A) for subtle separation and depth.
- Primary accents: Indigo-500 (#6366F1) for interactive elements and highlights.
- Font choice: 'Inter' for a clean, modern, readable sans-serif style across all text elements. Note: currently only Google Fonts are supported.
- Utilize rounded-xl corners, subtle borders (border-white/10), and soft gradients to achieve a modern design.
- Incorporate Framer Motion for page transitions and micro-interactions to enhance the user experience.