...
// [STABILITY_ANCHOR: ADMIN_MODULAR_IMPORTS]
    ...
    <div className="p-8 max-w-7xl mx-auto flex flex-col min-h-screen gap-8 animate-in fade-in duration-700 font-sans">
      <div className="flex justify-between items-center flex-row-reverse">
        <div className="text-right">
          ...
          <p className="text-muted-foreground mt-1 text-base">نظام الرقابة والتحكم الموزع - إدارة السيادة والبروتوكولات.</p>
        </div>
        <Button variant="outline" size="icon" onClick={loadAllData} disabled={isLoading} className="size-12 rounded-xl border border-white/5 bg-white/5 hover:bg-white/10 transition-all">
