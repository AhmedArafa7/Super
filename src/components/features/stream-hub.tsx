    ...
    <div className="p-8 max-w-7xl mx-auto min-h-screen">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-12 gap-6">
        <div>
          ...
          <p className="text-muted-foreground mt-2 text-lg">بث لامركزي ورفع ملفات في الخلفية دون قيود المساحة.</p>
        </div>
            ...
            <DialogContent className="sm:max-w-[550px] bg-slate-950 border-white/10 rounded-[2.5rem] p-8">
              <DialogHeader>
                ...
                <DialogDescription className="text-muted-foreground text-sm text-right">
                  ارفع ملفات بأي مساحة. سنتولى المزامنة في الخلفية حتى لا تضطر للانتظار.
                </DialogDescription>
              </DialogHeader>
                    ...
                    <div className="relative h-32 bg-white/5 border-2 border-dashed border-white/10 rounded-2xl flex flex-col items-center justify-center cursor-pointer hover:bg-white/10 transition-all">
                      ...
                      {uploadData.file ? (
                        <div className="text-center">
                          ...
                          <p className="text-[10px] text-muted-foreground">{(uploadData.file.size / 1024 / 1024).toFixed(2)} MB تم اكتشافها</p>
                        </div>
                      ) : (
                        <>
      ...
      <Dialog open={!!selectedVideo} onOpenChange={() => setSelectedVideo(null)}>
        <DialogContent className="max-w-5xl bg-black border-white/10 p-0 overflow-hidden rounded-[2.5rem]">
          ...
          <div className="p-8 bg-slate-950 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="flex-1">
              <h2 dir="auto" className="text-3xl font-headline font-bold text-white text-right mb-2">{selectedVideo?.title}</h2>
            ...
            <div className="flex items-center gap-4 bg-white/5 p-4 rounded-2xl border border-white/10">
              <div className="text-right">
                ...
                <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-widest">مصدر البيانات المحلي</p>
              </div>
