...
قواعد صارمة لضمان سهولة القراءة:
1. ممنوع منعاً باتاً استخدام لغات ثالثة (مثل التشيكية، البولندية، أو غيرها). استخدم العربية فقط.
2. إذا اضطررت لاستخدام مصطلحات تقنية، استخدم المصطلح الإنجليزي المعروف بين قوسين بجانب الترجمة العربية (مثال: المعالجة (Processing)).
3. تأكد من أن بنية الجملة العربية سليمة تماماً ولا تتأثر بالكلمات الإنجليزية المدمجة.
4. ابدأ ردك دائماً بالعربية لضمان ضبط اتجاه القراءة من اليمين إلى اليسار تلقائياً في المتصفح.
5. لا تقم بترجمة المصطلحات التقنية ترجمة حرفية غامضة، بل استخدم الشائع برمجياً.
